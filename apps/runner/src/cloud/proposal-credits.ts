...
export const CREDIT_DEPLOYMENT = "contracts/proposal-credits-v2.json";
...
export const proposalCreditsAbi = parseAbi([
  ...
  "function registerRunPolicy(uint256 taskId, bytes32 runHash, uint8 allowance, uint64 expiresAt, uint8 proposalCost, uint256 proposalThreshold)",
