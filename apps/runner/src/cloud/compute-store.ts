...
const recordSchema = z.object({
  ...
  approvedProposalIds: z.array(z.string().regex(/^[0-9]+$/)).max(40).optional(),
  observedProposalIds: z.array(z.string().regex(/^[0-9]+$/)).max(40).optional(),
  waitingForProposal: z.boolean().optional(),
