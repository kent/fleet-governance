...
export function experimentMcpServer(operator: OperatorEmail) {
  ...
  server.registerTool("experiment_defaults", { description: "Get the supported pilot parameters and limits. No execution.", inputSchema: {}, annotations: readOnly }, async () => result({ defaults: experimentDefaults(), minAgents: 3, maxAgents: 5, maxRunBudgetUsd: 1, maxBatchRuns: 25, defaultBatchBudgetUsd: 10, modelPoolUsd: 50 }));
